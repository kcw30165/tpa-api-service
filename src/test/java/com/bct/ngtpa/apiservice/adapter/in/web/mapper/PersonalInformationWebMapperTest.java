...
class PersonalInformationWebMapperTest {
    ...
    @Test
    void mapsApimDataToBffFieldsUsingYamlApimBinding() {
        ...
        List<?> fields = (List<?>) addressSection.get("fields");
    ...
    private BffPagesProperties pageConfig() {
        ...
        section.setFields(List.of(
                field("residentialAddressLine1", "Residential Address Line 1", "addr1"),
    ...
    private FieldProperties field(String id, String label, String apimField) {
        ...
        binding.setData(apimField);
        binding.setConfig(apimField);
