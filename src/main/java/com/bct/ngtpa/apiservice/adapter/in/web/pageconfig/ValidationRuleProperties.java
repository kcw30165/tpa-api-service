...
public class ValidationRuleProperties {
    ...
    public Map<String, Object> getValueByVariant() {
        return valueByVariant;
    }
    public void setValueByVariant(Map<String, Object> valueByVariant) {
        this.valueByVariant = valueByVariant;
    }
