 ...
 *
 * <p>This class is framework-free so the same contract values can be referenced from application,
...
public final class ErrorCodes {
    ...
    public static final String CONFIG_ERROR_MESSAGE_MISSING =
            "err.config.error-message.missing";
    public static final String CONFIG_RESOLUTION_FAILED = "err.config.resolution.failed";

    public static final String CONTRIBUTION_REQUEST_INVALID =
            "err.contribution.request.invalid";
    public static final String NOTIFICATION_REQUEST_INVALID =
